...
public class PlayerMovementSystem {
    ...
    public void updatePlayerMovement() {
        for (var player: players) {
            ...
            if ((player.getPositionComponent().getX() + player.getMovementComponent().getDx()) > player.getSizeComponent().getScreenwidth() / player.getSizeComponent().getSize() - 1) {
                player.getPositionComponent().setX(player.getSizeComponent().getScreenwidth() / player.getSizeComponent().getSize() - 2);
            }
